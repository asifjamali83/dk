...
#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
kc = LineClient(authToken="EGiuReAucQsVEKSNatQd.JZJ/1Jhb9oyNKqIA+uiyFq.QJ9tVWrZMmhyyulcm7R6vSZVk9u4ZUhWn4aoJ5k/Jys=")
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
kb = LineClient(authToken="EGlC1pdwAXgJa8ifvhQa.uA70OmZ6xGXhLjifkBHlgG.wqHsMSr4AfbP8t5NwXO1XPvkDkc2PLshNy8PWSzm9S0=")
kb.log("Auth Token : " + str(kb.authToken))
kb.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
kd = LineClient(authToken="EGHVHQWEY3OGinSx1eBb.bAXEGo6vXQI0VRhomlb3MW.D2Ch7Mnin3AnG1GYCwzuBTbpJ13bOszfgTPgg/E6PZo=")
kd.log("Auth Token : " + str(kd.authToken))
kd.log("Channel Access Token : " + str(channel.channelAccessToken))

#eq= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
ke = LineClient(authToken="EG77xdQ4R1Orpy0JONr9.sq7xakrN1v28/yW8CSq42q.hvNuXc0CC8lDzkLPvkLVKSDpEkIbk2jXcw0cNsrmDzE=")
ke.log("Auth Token : " + str(ke.authToken))
ke.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
kf = LineClient(authToken="EGJFuACeU0sw0r8JRX32.XhCwJBakhq3WIw4uZqu08G.z7q0g96+5epKTiAMuyT1A+5oGo8VgH49kjopLOBRg4U=")
kf.log("Auth Token : " + str(kf.authToken))
kf.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
kg = LineClient(authToken="EGGClmQirMaJ0F8k82Zc.CCslx0hiYMYz0Wkvw5ctJa.ctRkOS2hBFAyIdSuSG94pagmQRha4jzxQdgb/DACxpo=")
kg.log("Auth Token : " + str(kg.authToken))
kg.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
kh = LineClient(authToken="EGLzQBM8NA4AfM6sfb77.4ciXpOp+ngV1ye23dcM5vW.S/kTLzg1S9zGdNQdLdcSu9JQ3FkVl8c30aNBxIhqmDg=")
kh.log("Auth Token : " + str(kh.authToken))
kh.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
kj = LineClient(authToken="EGr1wIZYFwsBaxAQZ747.8d+/mNO13JPYidbljC3nvW.MU6tSIUoyfKFCJ5ZqJsffElS+JKI9/huIKZNIOSSNhQ=")
kj.log("Auth Token : " + str(kj.authToken))
kj.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
sw = LineClient(authToken="EGZbg9q4XATCA8uCvqWe.yDd/ESRdVqhoxLV9ogigNG.Jq/aRz+Raef8WQE3ZjeAPzjCg5SXuU6sGpu4KThcroM=")
